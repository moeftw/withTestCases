...
public class AddEmployeePage extends CommonAPI {
    ...
    public boolean showsFirstAndLastName() {
        String messageText = firstNameLastName.getText();
        return messageText.contains("John Doe");
